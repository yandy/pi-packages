...
import { formatDenyReason, formatUnavailableReason, formatUserDeniedReason } from "../../denial-messages";
...
export class GateRunner {
	...
	private async runDescriptor(
		...
		if (check.source === "session") {
			...
			this.reporter.emitDecision(buildDecisionEvent(descriptor.decision, check, agentName, "allow", "session_approved"));
			return { action: "allow" };
		}
