...
import { ToolPreviewFormatter, type ToolPreviewFormatterOptions } from "../../tool-preview-formatter";
			...
			() => {
				...
				const toolCheck =
					tcc.toolName === "bash" && bashProgram
						? resolveBashCommandCheck(command ?? "", bashProgram.commands(), tcc.agentName ?? undefined, this.resolver)
