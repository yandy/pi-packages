...
digraph process {
    ...
    "Dispatch final code reviewer (../supo-requesting-code-review/code-reviewer.md)" [shape=box];
    ...
    "More tasks remain?" -> "Dispatch final code reviewer (../supo-requesting-code-review/code-reviewer.md)" [label="no"];
    "Dispatch final code reviewer (../supo-requesting-code-review/code-reviewer.md)" -> "Final findings? ONE fix dispatch, one scoped re-review, adjudicate residuals";
    "Final findings? ONE fix dispatch, one scoped re-review, adjudicate residuals" -> "Final review clean: delete this plan's workspace";
    "Final review clean: delete this plan's workspace" -> "Use supo-finishing-a-development-branch";
}
```
...
supo-using-git-worktrees to create one or verify the existing one.
...
[code-reviewer.md](../supo-requesting-code-review/code-reviewer.md). Point it at
...
Use supo-finishing-a-development-branch.
...
Done! Using supo-finishing-a-development-branch.
```
