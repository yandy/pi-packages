...
Prefer supo-subagent-driven-development when your human partner
...
The workspace and ledger are shared with supo-subagent-driven-development
...
**REQUIRED SUB-SKILL:** load supo-test-driven-development now,
...
order under supo-test-driven-development, loaded at setup. A test
...
- **Matches.** Next step.
- **The code is wrong.** Use supo-systematic-debugging. Find the
...
**REQUIRED SUB-SKILL:** supo-verification-before-completion governs
...
Using supo-finishing-a-development-branch.
```
