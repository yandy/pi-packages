...
// CONFIG_DIR_NAME is ".pi" (from @earendil-works/pi-coding-agent's piConfig.configDir)
// but it is not re-exported from the package's main entry point, so we define it locally.
